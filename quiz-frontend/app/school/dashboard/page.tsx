...
//       {/* Pagination */}
//       <div className="flex gap-2 mt-4 flex-wrap text-black">
      ...
      {pages > 1 && (
        <div className="flex items-center justify-center gap-2 mt-6">
          ...
          <button
            ...
            disabled={page === 1}
            className="px-4 py-2 rounded-lg border border-gray-300 bg-white text-gray-700 hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed transition font-medium text-sm"
          >
            Prev
          </button>
          ...
          <div className="flex gap-1">
            {Array.from({ length: pages }, (_, i) => {
              ...
              const showEllipsisAfter = pageNum === page + 2 && page < pages - 2;
